...
-(void)controllBar{
    ...
    self.progressSlider = [self.object slider:NSSliderTypeLinear frame:NSMakeRect(270, 15, 450, 8)  superView:self.contentView target:self action:@selector(progressAction:)];
